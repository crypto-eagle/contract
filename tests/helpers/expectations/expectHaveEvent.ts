...
export const expectHaveOnlyOneEvent = (contract: SandboxContract<MainContract | FounderContract>, deployer: SandboxContract<TreasuryContract>, result: SendMessageResult, value: bigint) => {
